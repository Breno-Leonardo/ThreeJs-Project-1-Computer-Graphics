...
var 	scene,
		renderer,
		camera,clock,obj,positionYMax,positionXMax,positionXMin,positionYMin,positionZMax,positionZMin,
		camControl;
...
function main() {
	...
	camera = new THREE.PerspectiveCamera( 75.0, window.innerWidth/window.innerHeight, 0.01, 500.0);
...
function ajusteCamera() {
	...
	camera.position.y = box.max.y / 3;
	positionYMax=box.max.y;
	positionYMin=box.min.y;
	...
	camControl.lookSpeed = 0.05;
	camControl.movementSpeed = 300;
...
function render() {
	...
	maxZ=positionZMax-positionZMax*0.1,maxY=positionYMax-positionYMax*0.1,
	minY=positionYMin-positionYMin*0.5; 
